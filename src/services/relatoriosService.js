...
export async function obterFaturamentoDiario(ownerId) {
...
export async function obterTopProdutos(ownerId) {
...
export async function obterVendasRecentes(ownerId) {
...
export async function obterResumoMensal(ownerId) {
